...
options::options()
   ...
   drilling_options.add_options()
       ...
       ("drillprobe", po::value<bool>()->default_value(false)->implicit_value(true), "Enable length probing after eachdrill bit change")
       ("dp-endpoint", po::value<double>(), "Z value down to which will be probed")
       ("dp-feed", po::value<int>(), "Feed rate for probing (vertical speed)")
